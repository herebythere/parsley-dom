...
function findRemovalTargets(delta, render, sourceId) {
...
function addRenderTargets(utils, delta, render, parentId, source) {
    ...
    while(index < render.sources.length - 1){
        ...
        if (source1 instanceof Draw && result instanceof Build) {
...
function diffRootNodes(utils, targets, sources, render, prevRender) {
    ...
    for(let index = 0; index < minLength; index++){
        ...
        addRenderTargets(utils, targets, render, -1, curr);
    }
