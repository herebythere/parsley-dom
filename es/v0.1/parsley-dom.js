...
function addSourceToRender(utils, render, sourceIndexArray, source) {
...
function addSource(utils, render, sourceIndexArray, source) {
...
function addRootToRender(utils, render, sourceIndexArray) {
